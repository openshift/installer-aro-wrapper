...
import (
	...
	storagesdk "github.com/openshift/ARO-Installer/pkg/util/azureclient/azuresdk/armstorage"
	"github.com/openshift/ARO-Installer/pkg/util/azureclient/azuresdk/azblob"
)
