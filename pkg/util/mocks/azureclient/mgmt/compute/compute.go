...
// Source: github.com/openshift/installer-aro-wrapper/pkg/util/azureclient/mgmt/compute (interfaces: DisksClient,ResourceSkusClient,VirtualMachinesClient,UsageClient,VirtualMachineScaleSetVMsClient,VirtualMachineScaleSetsClient,DiskEncryptionSetsClient)
//
// Generated by this command:
//
//	mockgen -destination=../../../../util/mocks/azureclient/mgmt/compute/compute.go github.com/openshift/installer-aro-wrapper/pkg/util/azureclient/mgmt/compute DisksClient,ResourceSkusClient,VirtualMachinesClient,UsageClient,VirtualMachineScaleSetVMsClient,VirtualMachineScaleSetsClient,DiskEncryptionSetsClient
//
...
func (m *MockVirtualMachinesClient) StopAndWait(ctx context.Context, resourceGroupName, VMName string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StopAndWait", ctx, resourceGroupName, VMName)
	ret0, _ := ret[0].(error)
	return ret0
}

// StopAndWait indicates an expected call of StopAndWait.
func (mr *MockVirtualMachinesClientMockRecorder) StopAndWait(ctx, resourceGroupName, VMName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StopAndWait", reflect.TypeOf((*MockVirtualMachinesClient)(nil).StopAndWait), ctx, resourceGroupName, VMName)
}
