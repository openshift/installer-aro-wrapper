...
// Source: github.com/openshift/installer-aro-wrapper/pkg/proxy (interfaces: Dialer)
//
// Generated by this command:
//
//	mockgen -destination=../util/mocks/proxy/proxy.go github.com/openshift/installer-aro-wrapper/pkg/proxy Dialer
//
