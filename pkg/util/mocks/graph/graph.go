...
//
//	mockgen -destination=../../util/mocks/graph/graph.go github.com/openshift/installer-aro-wrapper/pkg/cluster/graph Manager
//
...
func (m *MockManager) GetUserDelegatedSASIgnitionBlobURL(ctx context.Context, resourceGroup, account, blobURL string, usesWorkloadIdentity bool) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserDelegatedSASIgnitionBlobURL", ctx, resourceGroup, account, blobURL, usesWorkloadIdentity)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockManagerMockRecorder) GetUserDelegatedSASIgnitionBlobURL(ctx, resourceGroup, account, blobURL, usesWorkloadIdentity any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserDelegatedSASIgnitionBlobURL", reflect.TypeOf((*MockManager)(nil).GetUserDelegatedSASIgnitionBlobURL), ctx, resourceGroup, account, blobURL, usesWorkloadIdentity)
}
...
func (m *MockManager) Save(ctx context.Context, resourceGroup, account string, g graph.Graph) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", ctx, resourceGroup, account, g)
	ret0, _ := ret[0].(error)
	return ret0
}

// Save indicates an expected call of Save.
func (mr *MockManagerMockRecorder) Save(ctx, resourceGroup, account, g any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockManager)(nil).Save), ctx, resourceGroup, account, g)
}
