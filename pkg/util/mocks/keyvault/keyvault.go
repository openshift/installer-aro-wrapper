...
// Source: github.com/openshift/installer-aro-wrapper/pkg/util/keyvault (interfaces: Manager)
//
// Generated by this command:
//
//	mockgen -destination=../mocks/keyvault/keyvault.go github.com/openshift/installer-aro-wrapper/pkg/util/keyvault Manager
//
...
func (m *MockManager) SetCertificateIssuer(ctx context.Context, issuerName string, parameter keyvault.CertificateIssuerSetParameters) (keyvault.IssuerBundle, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetCertificateIssuer", ctx, issuerName, parameter)
...
func (mr *MockManagerMockRecorder) SetCertificateIssuer(ctx, issuerName, parameter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCertificateIssuer", reflect.TypeOf((*MockManager)(nil).SetCertificateIssuer), ctx, issuerName, parameter)
}
