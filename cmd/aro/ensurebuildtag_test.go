...
func TestEnsureAroTag(t *testing.T) {
	...
	*/
	...
	if !platformIsAro {
		t.Fatalf("installer-aro-wrapper must be built, run, and tested with '-tags aro' to support github.com/openshift/installer, see https://github.com/openshift/installer/pull/4843/files")
	}
}
