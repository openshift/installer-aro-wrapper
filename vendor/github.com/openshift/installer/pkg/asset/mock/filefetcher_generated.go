...
//
//	mockgen -source=./filefetcher.go -destination=./mock/filefetcher_generated.go -package=mock
//
...
import (
	...
	asset "github.com/openshift/installer-aro-wrapper/vendor.bak/github.com/openshift/installer/pkg/asset"
...
func (mr *MockFileFetcherMockRecorder) FetchByName(arg0 any) *gomock.Call {
...
func (mr *MockFileFetcherMockRecorder) FetchByPattern(pattern any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
