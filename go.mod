...
replace (
	...
	github.com/openshift/installer => github.com/openshift/installer-aro v0.9.0-master.0.20240214010831-fd48bf30c1af
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20240220165321-d3514b65c5e4
