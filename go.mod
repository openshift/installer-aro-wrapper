...
replace (
	...
	github.com/openshift/installer => github.com/openshift/installer-aro v0.9.0-master.0.20240816131302-eb0befb09bf8
	...
	sigs.k8s.io/cluster-api-provider-azure => github.com/openshift/cluster-api-provider-azure v0.1.0-alpha.3.0.20240812021216-a1b2a37b7d31
