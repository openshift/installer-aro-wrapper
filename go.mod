...
require (
	...
	k8s.io/cloud-provider-vsphere v1.28.4 // indirect
...
replace (
	...
	k8s.io/cloud-provider-vsphere => github.com/openshift/cloud-provider-vsphere v1.19.1-0.20240910054550-81ad52ad7bcf
)
