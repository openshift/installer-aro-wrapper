...
require (
	...
	github.com/openshift/installer v1.4.21-rc2.0.20260203032034-2c105c33e9e3
...
// OpenShift Forks (synced with installer release-4.21)
replace (
...
// Assisted service replace directives (synced with installer release-4.21)
replace (
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20250922204150-a52b83145bea
	github.com/openshift/assisted-service/client => github.com/openshift/assisted-service/client v0.0.0-20250922204150-a52b83145bea
...
// Temporary vendoring of upstream providers (synced with installer release-4.21)
