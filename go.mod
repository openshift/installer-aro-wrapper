...
replace (
	...
	github.com/openshift/installer => github.com/openshift/installer-aro v0.9.0-master.0.20240722135710-cd081ae62e66
	...
	sigs.k8s.io/cluster-api-provider-aws => github.com/openshift/cluster-api-provider-aws v0.2.1-0.20231117101239-16156accbe3b
	sigs.k8s.io/cluster-api-provider-azure => github.com/openshift/cluster-api-provider-azure v0.1.0-alpha.3.0.20231116153230-32491247e933
	sigs.k8s.io/cluster-api-provider-openstack => github.com/openshift/cluster-api-provider-openstack v0.0.0-20231025170647-f13e381e9627
...
replace (
	...
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20240418135216-844e6efd0d1c
	github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models v0.0.0-20240418135216-844e6efd0d1c
	...
	sigs.k8s.io/cluster-api => github.com/openshift/cluster-api v0.0.0-20231116115436-03d89f216e0f
	sigs.k8s.io/cluster-api-provider-ibmcloud => github.com/openshift/cluster-api-provider-ibmcloud v0.0.0-20231208013118-0fe74f674bf5
)

replace github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20221019143426-16aed247da5c

replace sigs.k8s.io/cluster-api-provider-libvirt => github.com/openshift/cluster-api-provider-libvirt v0.2.1-0.20220706171430-a2882f7aa56d
